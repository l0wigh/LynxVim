...
This is a very lightweight NeoVim configuration, made after that a another plugin broke LionVim for no reason.
...
## What is installed in this ?
    ...
    - Fleet and *Catppuccin* (default) for colorschemes
